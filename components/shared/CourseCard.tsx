...
export default function CourseCard({
  ...
  return (
    <Link href={`/courses/${id}`} className="group block h-full">
      <div className="rounded-2xl overflow-hidden border border-border/50 bg-card hover:border-primary/30 hover:shadow-xl hover:shadow-primary/5 transition-all duration-300 h-full flex flex-col">
        ...
        <div className="relative aspect-video bg-muted overflow-hidden">
          ...
          {/* Level badge — only shown when level context is unknown */}
          {level && (
        ...
        <div className="p-4 flex flex-col flex-1 gap-2">
          ...
          <div className="flex items-center gap-2 pt-1">
            ...
            <span className="text-xs text-muted-foreground truncate font-medium">{displayName}</span>
          </div>
